            ...
            <div class="panel panel-default" style="margin:  10rem 0 5rem 0;">
              <div class="panel-body">
                <div class="text-center">
                  <h1><i class="fa fa-key" aria-hidden="true"></i></h1>
                  ...
                  <div class="panel-body">
    				...
    				%>
                    <form id="register-form" role="form" autocomplete="off" class="form" method="post" action="<%=request.getContextPath()%>/newpass">
    					<input name="email" value="<%=email%>" hidden="hidden">
                      <div class="form-group">
                        <div class="input-group">
                          <input type="password" id="pass" name="pass" placeholder="Mật khẩu mới ..." class="form-control">
                        </div><br />
                        <div class="input-group">
                          <input type="password" name="repass" placeholder="Xác nhận mật khẩu ..." class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
