...
<footer class="sticky-footer bg-white">
    ...
    <script src="<%=request.getContextPath()%>/templates/admin/js/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script src="<%=request.getContextPath()%>/templates/admin/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="<%=request.getContextPath()%>/templates/admin/js/demo/chart-area-demo.js"></script>
    <script src="<%=request.getContextPath()%>/templates/admin/js/demo/chart-pie-demo.js"></script>
